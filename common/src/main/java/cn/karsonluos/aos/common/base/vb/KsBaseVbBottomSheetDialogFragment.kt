...
import cn.karsonluos.aos.common.base.KsBaseBottomSheetDialogFragment
...
open class KsBaseVbBottomSheetDialogFragment<T: ViewBinding> : KsBaseBottomSheetDialogFragment() {
    protected lateinit var mViewBinding : T

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val vbClazz = KsReflectUtils.findGenericParameter<T>(javaClass, KsBaseVbBottomSheetDialogFragment::class.java, 0)
